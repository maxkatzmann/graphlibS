# graphlibS
[![GitHub tag](https://img.shields.io/badge/Version-0.0.43-brightgreen.svg)](https://github.com/maxkatzmann/graphlibS/releases/tag/0.0.43)
...
**Output**
* print the adjacency list of a graph (supported format are: edgelist, GML, DL)
